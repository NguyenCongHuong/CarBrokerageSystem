...
public class EditProducerAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		producerBO.editProducer(producerForm.getProducerID(), producerForm.getProducerName());

		return mapping.findForward("editProducer");
	}
